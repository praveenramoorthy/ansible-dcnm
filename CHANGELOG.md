...
### Added
* Support to configure 60 multiple interfaces for vrf_lite on a vrf
* Added support for more switch roles in inventory module.
* Change 3
...
### Added
* Support to configure 30 multiple interfaces for vrf_lite on a vrf
* Added support for more switch roles in inventory module.
* Change 3
...
### Added
* Support to configure 10 multiple interfaces for vrf_lite on a vrf
* Added support for more switch roles in inventory module.
* Change 3
...
[9.40.10]: https://github.com/CiscoDevNet/ansible-dcnm/compare/3.3.1...9.40.10
